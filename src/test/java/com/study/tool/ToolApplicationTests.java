...
public final Logger log = LoggerFactory.getLogger(ToolApplicationTests.class);

private final Addresses addressess = new Addresses("311 West Doersey", "Memphis","TN", "38119");
...
public void testMath(){
    log.info("Division {}", quotient(10, 100));
    //Verify succeed
...
void timeoutNotExceededWithMethod() {
        ...
        String actualGreeting = assertTimeout(ofMinutes(2), ToolApplicationTests::greeting);
